...
EXES = android_test android_build android_publish_rc android_publish_release android_deploy android_update_candidate_sample_app_rc android_app_clean_sample_apps android_app_copy_from_vendor android_app_merge_into_complete_sample_app android_app_update_from_target_location
