...
public class Images {
  ...
  public static void play(Canvas c, Paint p, int width, int height, int marginPixels) {
    ...
    path.lineTo((float)width-(float)marginPixels, (float)marginPixels+((float)height-2f*(float)marginPixels)/2f);
  ...
  public static void fullscreen(Canvas c, Paint p, int width, int height, int marginPixels) {
    ...
    c.drawLine(marginX+strokeWidth, marginY+strokeWidth, marginX+widthMinusMargins/2.0f - strokeWidth/2.0f, marginY+heightMinusMargins/2.0f - strokeWidth/2.0f, linePaint);
    c.drawLine(marginX+widthMinusMargins-strokeWidth, marginY+heightMinusMargins-strokeWidth, marginX+widthMinusMargins/2.0f + strokeWidth/2.0f, marginY+heightMinusMargins/2.0f + strokeWidth/2.0f, linePaint);
  }
  ...
  public static void smallscreen(Canvas c, Paint p, int width, int height, int marginPixels) {
    ...
    float strokeWidth = widthMinusMargins/5.0f;
    linePaint.setStrokeWidth(strokeWidth);
    c.drawLine(marginX, marginY, marginX+widthMinusMargins/2.0f - strokeWidth, marginY+heightMinusMargins/2.0f - strokeWidth, linePaint);
    c.drawLine(marginX+widthMinusMargins, marginY+heightMinusMargins, marginX+widthMinusMargins/2.0f + strokeWidth, marginY+heightMinusMargins/2.0f + strokeWidth, linePaint);
    // Top triangle
    path.moveTo(marginX+(widthMinusMargins/2.0f)-strokeWidth/4.0f, marginY);
    path.lineTo(marginX+(widthMinusMargins/2.0f)-strokeWidth/4.0f, marginY+(heightMinusMargins/2.0f)-strokeWidth/4.0f);
    ...
    // Bottom triangle
    path.moveTo(marginX+widthMinusMargins/2.0f+strokeWidth/4.0f, marginY+(heightMinusMargins/2.0f)+strokeWidth/4.0f);
  ...
  public static void next(Canvas c, Paint p, int width, int height, int marginPixels) {
    ...
    // Left Arrow
    path.moveTo((float)marginPixels, (float)marginPixels);
    path.lineTo((float)marginPixels+((widthMinusMargins-barWidth)/2f), (float)marginPixels+(heightMinusMargins)/2f);
    ...
    path.lineTo((float)marginPixels+widthMinusMargins-barWidth, (float)marginPixels+(heightMinusMargins)/2f);
    path.lineTo((float)marginPixels+((widthMinusMargins-barWidth)/2f), (float)marginPixels+heightMinusMargins);
    ...
    c.drawLine((float)marginPixels+(widthMinusMargins)-barWidth/2f, (float)marginPixels, (float)marginPixels+(widthMinusMargins)-barWidth/2f, (float)marginPixels+heightMinusMargins, linePaint);
  }
  ...
  public static void previous(Canvas c, Paint p, int width, int height, int marginPixels) {
    ...
    linePaint.setStyle(Paint.Style.STROKE);
    linePaint.setStrokeWidth(barWidth);
    c.drawLine((float)marginPixels+barWidth/2f, (float)marginPixels, (float)marginPixels+barWidth/2f, (float)marginPixels+heightMinusMargins, linePaint);
    // Left Arrow
    ...
    path.lineTo((float)marginPixels+barWidth+((widthMinusMargins-barWidth)/2f), (float)marginPixels+heightMinusMargins);
    path.lineTo((float)marginPixels+barWidth, (float)marginPixels+heightMinusMargins/2f);
    // Right Arrow
    path.moveTo((float)marginPixels+barWidth+((widthMinusMargins-barWidth)/2f), (float)marginPixels+heightMinusMargins/2f);
    ...
    path.lineTo((float)marginPixels+barWidth+((widthMinusMargins-barWidth)/2f), (float)marginPixels+heightMinusMargins/2f);
    c.drawPath(path, p);
  }

  public static void drawImage(int i, Context ct, Canvas c, int background, int fill, int width, int height, int marginDP, boolean glow) {
    ...
    if (glow) {
      GradientDrawable glowDrawable = new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP, new int[] {0xFFFFFFFF, 0x00FFFFFF});
