...
public class PlayerAPIClientTest extends AndroidTestCase {
  ...
  protected void setUp() {
    api = new PlayerAPIClient(new OoyalaAPIHelper(TestConstants.TEST_API_KEY, TestConstants.TEST_SECRET), TestConstants.TEST_PCODE, "www.ooyala.com");
  }
  ...
  public void testAuthorizeVideo() throws OoyalaException {
    ...
    assertTrue(((Video)video).getStream().decodedURL().toString().equals("http://ak.c.ooyala.com/UwN2wxMzpU1Nl_qojlX8iLlKEHfl4HLM/DOcJ-FxaFrRg4gtGMwOjRpOmc3OzS3Gm") ||
               ((Video)video).getStream().decodedURL().toString().equals("http://ak.c.ooyala.com/UwN2wxMzpU1Nl_qojlX8iLlKEHfl4HLM/DOcJ-FxaFrRg4gtGIwOjRpOmc3OxgEkc"));

    video = ContentItem.create(ContentItemTest.getTestJSON(TestConstants.TEST_DICTIONARY_VIDEO_WITH_AD_OOYALA), TestConstants.TEST_VIDEO_WITH_AD_OOYALA, api);
    assertTrue(api.authorize(video));
    assertTrue(video.isAuthorized());
    assertEquals(video.getAuthCode(), AuthCode.AUTHORIZED);
    assertTrue(video instanceof Video);
    assertTrue(((Video)video).getStream().decodedURL().toString().equals("http://ak.c.ooyala.com/g3N2wxMzqxoB84c3dan5xyXTxdrhX1km/DOcJ-FxaFrRg4gtGMwOjRpOmc3OzS3Gm") ||
               ((Video)video).getStream().decodedURL().toString().equals("http://ak.c.ooyala.com/g3N2wxMzqxoB84c3dan5xyXTxdrhX1km/DOcJ-FxaFrRg4gtGIwOjRpOmc3OxgEkc"));
    assertTrue(((Video)video).fetchPlaybackInfo());
    assertTrue(((OoyalaAdSpot)((Video)video).getAds().get(0)).getStream().decodedURL().toString().equals("http://ak.c.ooyala.com/JzdHAxMzoJXCByNhz6UQrL5GjIiUrr_B/DOcJ-FxaFrRg4gtGMwOjRpOmc3OzS3Gm") ||
               ((OoyalaAdSpot)((Video)video).getAds().get(0)).getStream().decodedURL().toString().equals("http://ak.c.ooyala.com/JzdHAxMzoJXCByNhz6UQrL5GjIiUrr_B/DOcJ-FxaFrRg4gtGIwOjRpOmc3OxgEkc"));
    ...
    assertEquals(video.getAuthCode(), AuthCode.AUTHORIZED);
    assertTrue(video instanceof Video);
    assertEquals(((Video)video).getStream().decodedURL().toString(), "http://ak.c.ooyala.com/JzdHAxMzoJXCByNhz6UQrL5GjIiUrr_B/DOcJ-FxaFrRg4gtGEwOjFyazowazsvY7");
  ...
  public void testAuthorizeChannel() throws OoyalaException {
    ...
    assertTrue(((Channel)channel).firstVideo().getStream().decodedURL().toString().equals("http://ak.c.ooyala.com/JzdHAxMzoJXCByNhz6UQrL5GjIiUrr_B/DOcJ-FxaFrRg4gtGMwOjRpOmc3OzS3Gm") ||
  ...
  public void testAuthorizeChannelSet() throws OoyalaException {
    ...
    assertTrue(((ChannelSet)channelSet).firstVideo().getStream().decodedURL().toString().equals("http://ak.c.ooyala.com/JzdHAxMzoJXCByNhz6UQrL5GjIiUrr_B/DOcJ-FxaFrRg4gtGMwOjRpOmc3OzS3Gm") ||
  ...
  public void testAuthorizeDynamicChannel() throws OoyalaException {
    ...
    ContentItem dynamicChannel = ContentItem.create(ContentItemTest.getTestJSON(TestConstants.TEST_DICTIONARY_DYNAMIC_CHANNEL), embeds, api);
    ...
    assertTrue(firstVideo.getStream().decodedURL().toString().equals("http://ak.c.ooyala.com/UwN2wxMzpU1Nl_qojlX8iLlKEHfl4HLM/DOcJ-FxaFrRg4gtGMwOjRpOmc3OzS3Gm") ||
               firstVideo.getStream().decodedURL().toString().equals("http://ak.c.ooyala.com/UwN2wxMzpU1Nl_qojlX8iLlKEHfl4HLM/DOcJ-FxaFrRg4gtGIwOjRpOmc3OxgEkc"));
    assertTrue(secondVideo.getStream().decodedURL().toString().equals("http://ak.c.ooyala.com/g3N2wxMzqxoB84c3dan5xyXTxdrhX1km/DOcJ-FxaFrRg4gtGMwOjRpOmc3OzS3Gm") ||
  ...
  public void testContentTreeNext() throws OoyalaException {
    ...
    class TestPaginatedItemListener implements PaginatedItemListener {
      ...
      public void onItemsFetched(int firstIndex, int count,
        ...
        else { this.fetched = true; this.idx = firstIndex; this.cnt = count; }
      }
    };
    ...
    while(!listener.fetched && !listener.error) { try { Thread.sleep(1000); } catch (InterruptedException e) {} }
