...
public class VideoTest extends AndroidTestCase {
  ...
  public void testConstructor() {
    Video video = new Video(TestConstants.getTestJSON(TestConstants.TEST_DICTIONARY_VIDEO),
  ...
  public void testUpdate() {
    ...
    assertEquals("dancing", video.getDescription());
    assertEquals(Video.class, video.getClass());
    video.update(TestConstants.getTestJSON(TestConstants.TEST_DICTIONARY_VIDEO_AUTH_HLS));
    assertNotNull(video);
  ...
  public void testGetStream() {
    ...
    video.update(TestConstants.getTestJSON(TestConstants.TEST_DICTIONARY_VIDEO_AUTH_MP4));
    assertNotNull(video);
    assertEquals("http://ak.c.ooyala.com/UwN2wxMzpU1Nl_qojlX8iLlKEHfl4HLM/DOcJ-FxaFrRg4gtGEwOmk2OjBrO5dC5F",
        video.getStream().decodedURL().toString());

    video = new Video(TestConstants.getTestJSON(TestConstants.TEST_DICTIONARY_VIDEO),
        TestConstants.TEST_VIDEO, null);
    assertNotNull(video);
    assertEquals(TestConstants.TEST_VIDEO, video.getEmbedCode());
    assertEquals("Bhangra Empire - Boston Bhangra 2011 [Top View]", video.getTitle());
   ...
   */
  public void testAds() {
    Video video = new Video(TestConstants.getTestJSON(TestConstants.TEST_DICTIONARY_VIDEO_WITH_AD_OOYALA),
