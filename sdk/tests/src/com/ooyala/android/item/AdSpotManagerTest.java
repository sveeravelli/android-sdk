...
public class AdSpotManagerTest extends AndroidTestCase {
  ...
  public void testCuePointsWithPrerollOnly() {
    TestAdSpot s0 = TestAdSpot.create(0);

    AdSpotManager<TestAdSpot> manager = new AdSpotManager<TestAdSpot>();
    manager.insertAd(s0);
    assertTrue(manager.getCuePointsInMilliSeconds().isEmpty());
  }

  public void testCuePointsWithPreMidPostRolls() {
    TestAdSpot s0 = TestAdSpot.create(0);
    TestAdSpot s1 = TestAdSpot.create(1000);
    TestAdSpot s2 = TestAdSpot.create(2000);
    TestAdSpot s3 = TestAdSpot.create(3000);
    ...
    AdSpotManager<TestAdSpot> manager = new AdSpotManager<TestAdSpot>();
    manager.insertAds(adList);
    assertTrue(manager.getCuePointsInMilliSeconds().size() == 3);
    assertTrue(manager.getCuePointsInMilliSeconds().contains(1000));
    assertTrue(manager.getCuePointsInMilliSeconds().contains(2000));
    assertTrue(manager.getCuePointsInMilliSeconds().contains(3000));
  }

  public void testCuePointsWithAdsMarkedAsPlayed() {
    TestAdSpot s0 = TestAdSpot.create(0);
    TestAdSpot s1 = TestAdSpot.create(1000);
    TestAdSpot s2 = TestAdSpot.create(2000);
    TestAdSpot s3 = TestAdSpot.create(3000);
    ...
    assertTrue(manager.getCuePointsInMilliSeconds().size() == 3);
    manager.markAsPlayed(s1);
    assertTrue(manager.getCuePointsInMilliSeconds().size() == 2);
    assertTrue(!manager.getCuePointsInMilliSeconds().contains(1000));
    manager.markAsPlayed(s2);
    assertTrue(manager.getCuePointsInMilliSeconds().size() == 1);
    assertTrue(!manager.getCuePointsInMilliSeconds().contains(2000));
    manager.markAsPlayed(s3);
    assertTrue(manager.getCuePointsInMilliSeconds().isEmpty());
  ...
  public void testCuePointsWithAdSpotsOfSameTime() {
    TestAdSpot s0 = TestAdSpot.create(0);
    TestAdSpot s1 = TestAdSpot.create(1000);
