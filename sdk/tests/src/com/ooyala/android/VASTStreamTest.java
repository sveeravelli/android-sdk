...
public class VASTStreamTest extends AndroidTestCase {
  ...
  public void testInitializers() {
    try {
      ...
      assertEquals(stream.decodedURL(),new URL("http://vindicoasset.edgesuite.net/Repository/CampaignCreative/Campaign_8759/INSTREAMAD/93084_scrambled_eggs_10_v2_audio_17_03_11_MP4_360p_4x3.mp4"));
