...
public class HlsRendererBuilder implements RendererBuilder {
  ...
  @Override
  public void buildRenderers(RendererBuilderListener player) {
  ...
  private static final class AsyncRendererBuilder implements
    ...
    private final String userAgent;
    private final String url;
    private final RendererBuilderListener player;
    private final ManifestFetcher<HlsPlaylist> playlistFetcher;

    private boolean canceled;

    public AsyncRendererBuilder(Context context, String userAgent, String url, RendererBuilderListener player) {
      this.context = context;
      this.userAgent = userAgent;
      this.url = url;
      this.player = player;
    ...
    public void onSingleManifest(HlsPlaylist manifest) {
      ...
      HlsSampleSource sampleSource =
          new HlsSampleSource(
              chunkSource, loadControl, BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler,
              player, ExoStreamPlayer.TYPE_VIDEO);
      MediaCodecVideoTrackRenderer videoRenderer =
          new MediaCodecVideoTrackRenderer(
              context, sampleSource, MediaCodec.VIDEO_SCALING_MODE_SCALE_TO_FIT, 5000, mainHandler,
              player, 50);
