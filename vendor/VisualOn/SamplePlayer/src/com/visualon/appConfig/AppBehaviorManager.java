...
public interface AppBehaviorManager {
     ...
     * @return  {@link VO_OSMP_RETURN_CODE#VO_OSMP_ERR_NONE} if successful.
     */
    VO_OSMP_RETURN_CODE loadCfgFile(String filePath);
    ...
    /**
     * Update the option items
     *
     * @param   player   [in] Refer to {@link VOCommonPlayer}.
     *
     * @return  {@link VO_OSMP_RETURN_CODE#VO_OSMP_ERR_NONE} if successful.
     */
    VO_OSMP_RETURN_CODE updatePlayerOption(VOCommonPlayer player);
