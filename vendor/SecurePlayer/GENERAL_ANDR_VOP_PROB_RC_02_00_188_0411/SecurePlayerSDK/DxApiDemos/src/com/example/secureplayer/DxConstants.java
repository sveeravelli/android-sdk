...
public class DxConstants {
	...
	private static VO_OSMP_PLAYER_ENGINE PlayerType = VO_OSMP_PLAYER_ENGINE.VO_OSMP_VOME2_PLAYER;
	
	public static VO_OSMP_PLAYER_ENGINE getPlayerType() {
		return PlayerType;
	}
	
	public static void setPlayerType(String playerTypeStr) {
		if(playerTypeStr.equalsIgnoreCase("VO_OSMP_OMXAL_PLAYER")){
			PlayerType = VO_OSMP_PLAYER_ENGINE.VO_OSMP_OMXAL_PLAYER;
		} else if(playerTypeStr.equalsIgnoreCase("VO_OSMP_VOME2_PLAYER")){
			PlayerType = VO_OSMP_PLAYER_ENGINE.VO_OSMP_VOME2_PLAYER;
		}
