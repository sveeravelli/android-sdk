...
public class Utils {
	...
	/**
	 * Generate Streaming Downloader Destination Folder Name
	 * 
	 * @param url
	 *            Location of the file on the Internet
	 */
	static public String GenerateDownloadFolderName(String url) {
		String dirPath = String.valueOf(url.hashCode());
		dirPath = Environment.getExternalStorageDirectory() + File.separator + "SP" + File.separator + dirPath;
		return dirPath;
	}
